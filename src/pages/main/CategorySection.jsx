...
export default function CategorySection() {
  return (
    <div className="py-[6rem] md:px-[8%] px-3">
      <Heading1 text='ServiceConnect Categories' cName="text-center" />
      ...
      <button className="bg-lightgreen text-white px-6 py-2 rounded mx-auto my-0 block mt-6">Show More</button>
    </div>
  )
}
