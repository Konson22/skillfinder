  ...
  return (
    <div className="md:px-[8%] px-4 py-[4rem]">
        <div className="md:text-center md:px-[20%]">
            <h2 className="text-4xl md:font-bold font-light mb-3">Featured Providers</h2>
        ...
        <div className="text-center mt-6">
           <button className="bg-lightblue text-white rounded text-xl px-6 py-2">View All</button>
        </div>
    </div>
  )
}
